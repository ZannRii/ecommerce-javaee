...
<aside class="col-lg-3 col-xl-2">
	...
	<ul class="list-unstyled mb-0">
		...
		<li>
			<a class="btn btn-light w-100 text-start fw-semibold mb-2" data-bs-toggle="collapse" href="#products" role="button" aria-expanded="false" aria-controls="products"><i class="bi bi-box-seam me-2 text-success"></i>Products <i class="bi bi-chevron-down float-end"></i></a>
		...
		<li>
			<a class="btn btn-light w-100 text-start fw-semibold mb-2" data-bs-toggle="collapse" href="#categories" role="button" aria-expanded="false" aria-controls="categories"><i class="bi bi-tags me-2 text-success"></i>Categories <i class="bi bi-chevron-down float-end"></i></a>
		...
		<li>
			<a class="btn btn-light w-100 text-start fw-semibold mb-2" data-bs-toggle="collapse" href="#orders" role="button" aria-expanded="false" aria-controls="orders"><i class="bi bi-receipt me-2 text-success"></i>Orders <i class="bi bi-chevron-down float-end"></i></a>
		...
		<li>
			<a class="btn btn-light w-100 text-start fw-semibold mb-2" data-bs-toggle="collapse" href="#users" role="button" aria-expanded="false" aria-controls="users"><i class="bi bi-people me-2 text-success"></i>Users <i class="bi bi-chevron-down float-end"></i></a>
