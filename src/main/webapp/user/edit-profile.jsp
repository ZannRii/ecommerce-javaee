	...
	<main class="container py-5">
		...
		<div class="card border-0 shadow-sm">
			...
			<form action="update-profile" method="post">
				...
				<input class="form-control mb-3" type="text" name="name" value="<%=user.getName()%>">

				<label class="form-label fw-semibold">Phone</label>
				<input class="form-control mb-3" type="text" name="phone" value="<%=user.getPhone()%>">
				
				<label class="form-label fw-semibold">Email</label>
				<input class="form-control mb-3" type="text" name="email" value="<%=user.getEmail()%>">
