	...
	<main
		...
		<div class="card border-0 shadow-sm text-center w-100">
			<div class="card-body p-5">
				...
				<p class="text-secondary">Your order has been received and is
					being processed.</p>

				<div
					class="d-flex flex-column flex-sm-row gap-2 justify-content-center mt-4">

					<a href="home" class="btn btn-success"> Continue Shopping </a> <a
						href="my-orders" class="btn btn-outline-dark"> View My Orders
					</a>
