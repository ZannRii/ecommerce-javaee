...
<body class="bg-light">
		...
		<header class="navbar navbar-dark bg-dark px-3 px-lg-4 py-3">
			...
			<div class="d-flex align-items-center gap-2 flex-wrap">
				<a href="cart" class="btn btn-outline-warning"><i class="bi bi-cart3 me-1"></i> Cart <span id="cartCount" class="badge text-bg-warning ms-1">
						${cartCount} </span></a> <span class="text-white fw-semibold"> Hi, <%=user.getName()%>
				</span>
				<!-- DROPDOWN MENU -->
				<div class="dropdown">
	...
	<main class="container py-5">
		<h2 class="fw-bold mb-4"><i class="bi bi-box-seam text-success me-2"></i>Your Order History</h2>
		...
		<c:choose>
			...
			<c:when test="${empty detailedOrders}">
				<div class="card border-0 shadow-sm text-center py-5">
					...
					<p class="h5 fw-semibold mt-3">You haven't placed any orders with
						ShopHub yet!</p>
					...
					<div class="card-body">
						...
						<div class="d-flex flex-column flex-md-row justify-content-between gap-3 border-bottom pb-3 mb-3">
							<div class="meta-group">
								<span class="fw-bold d-block">Order ID: #${order.orderId}</span> <span
									class="text-secondary">Date Placed: ${order.createdAt}</span>
							</div>
							<div>
						...
						<div>
							<c:forEach var="item" items="${order.items}">
								<div class="d-flex flex-column flex-md-row justify-content-between gap-3 border-bottom py-3">
									<div class="d-flex align-items-center gap-3">
										<img class="rounded object-fit-cover" width="72" height="72" src="${item.imageUrl}"
									...
									<div class="text-md-end">
										<span class="text-secondary d-block">Unit: $${item.priceAtPurchase}</span>
										<strong>Subtotal:
						...
						<div class="d-flex flex-column flex-lg-row justify-content-between gap-3 pt-3">
							<div class="delivery-block">
								<span class="fw-semibold d-block"><i class="bi bi-geo-alt text-success me-1"></i>Delivery Location</span> <span
									class="text-secondary">${order.address}</span>
							</div>
