...
<body class="bg-light">
	...
	<main class="container py-5">
		...
		<div class="card border-0 shadow-sm">
			...
			<h3 class="h5 fw-bold mb-3"><i class="bi bi-geo-alt text-success me-2"></i>Delivery Address</h3>
			...
			<form action="place-order" method="post">
				...
				<textarea class="form-control mb-3" rows="5" name="address" required></textarea>

				<button type="submit" class="btn btn-success btn-lg w-100 fw-semibold">Place Order</button>
